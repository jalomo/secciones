...
<div id="files_bodys">
    ...
    <div id="content_admin">
        ...
        <div class="panel panel-default">
  		<div class="panel-heading" align="center"><h4> EDIT TUTORIAL</h4></div>
        ...
        <?php echo form_open_multipart('companies/save_tutorial', array('id'=>'save_cat','role'=>'form')); ?>
            ...
            <div class="form-group">
               ...
               <?php  $js = 'name="save[tutoriaIdCategoria]" id="tutoriaIdCategoria" class="form-control"';?>
               <?php echo form_dropdown('', $categorias, $tutorial->tutoriaIdCategoria, $js);?>
              </div>

             <div class="form-group">
			    <label for="">Name:</label>
			    <input type="text" class="form-control"  placeholder="Name in Spanish" name="save[tutorialNombre]" id="tutorialNombre" value="<?php echo $tutorial->tutorialNombre;?>">
			  </div>

			  <div class="form-group">
			    <label for="">Link:</label>
			    <input type="text" class="form-control"  placeholder="http://www.example.com/tutorial_example" name="save[tutorialLink]" id="tutorialLink" value="<?php echo $tutorial->tutorialLink;?>">
			  </div>

			  <div class="form-group">
			    <label for="ejemplo_archivo_1">Image</label> 
                <span class="glyphicon glyphicon-remove" title="remove image" style="cursor:pointer;"></span>

                <br/>
                <?php echo img(array('src'=>'statics/img/inicio-icono.png',
                                    'width'=>'200px',
                                    'height'=>'100px',
                                    'class'=>'img-thumbnail'))?>


			    <input type="file"  name="image" id="image" value="<?php echo $tutorial->tutorialImage;?>">
